...
import DeleteConfirmationModalComponent
    from "../../atoms/delete-confirmation-modal/delete-confirmation-modal-component";
...
const TableListSingleItemComponent:FC<SingleItemProps> = ({_id, id, first_name, last_name, 
    gender, email, number, photo, employee}) => {
